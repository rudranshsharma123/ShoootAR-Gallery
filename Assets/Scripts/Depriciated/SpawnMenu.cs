...
public void EndSession(){
    ...
    private void PlaneChanged( ARPlanesChangedEventArgs args)
    {
        ...
        if (args.added != null && placementObject == null)
        {                
            placePrefab.SetActive(true);
            
             ARPlane arplane = args.added[0];
            placementObject = Instantiate(placePrefab, arplane.transform.position, Quaternion.identity);
